...
# In bin/ : freenet.jar, freenet-ext.jar, seednodes.fref, bcprov-jdk15on-152.jar, wrapper.jar (version corresponding to the native wrapper binaries)
...
test -e bin/bcprov-jdk15on-152.jar || exit 4
...
cp bin/bcprov-jdk15on-152.jar offline/bcprov-jdk15on-152.jar || exit 14
